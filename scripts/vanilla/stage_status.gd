...
func native_update_data():
	...
	var description_path = GlobalVar.module_temp_data["stage"][t_stage[0]][t_stage[1]]["description"]["default"][GlobalSys.system_lang_zone]
	self.text = s_text + "  " + d_text + "  '" + description_path + "'"
